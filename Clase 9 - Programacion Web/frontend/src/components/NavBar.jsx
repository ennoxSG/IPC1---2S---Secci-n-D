                ...
                <div className="collapse navbar-collapse" id="navbarNav"> {/* Contenido que se colapsa/expande en pantallas pequeñas */}
                    <ul className="navbar-nav"> {/* Lista de enlaces de navegación */}
                        ...
                        <li className="nav-item">
                            ...
                            <Link className="nav-link" to="/admin/empleado">Empleados</Link>
                        </li>
                        <li className="nav-item"> {/* Elemento de la lista para otro enlace */}
...
export default Navbar; // Exportamos el componente Navbar para usarlo en otras partes de la aplicación
